...
機能をサービスとして提供し、標準化された契約を通じて複数システムを連携する設計です。
...
| 比較対象 | 違い |
| --- | --- |
| マイクロサービス | マイクロサービスは関連する問題領域で使われる。SOAは「機能をサービスとして提供し、標準化された契約を通じて複数システムを連携する設計です。」点を主に扱うため、導入目的と責務境界を分けて判断する |
| ESB | ESBは関連する問題領域で使われる。SOAは「機能をサービスとして提供し、標準化された契約を通じて複数システムを連携する設計です。」点を主に扱うため、導入目的と責務境界を分けて判断する |
| API Gateway Pattern | API Gateway Patternは関連する問題領域で使われる。SOAは「機能をサービスとして提供し、標準化された契約を通じて複数システムを連携する設計です。」点を主に扱うため、導入目的と責務境界を分けて判断する |
