...
企業内の複数システムをバス型の統合基盤で接続し、ルーティングや変換を担う構成です。
...
| 比較対象 | 違い |
| --- | --- |
| SOA | SOAは関連する問題領域で使われる。ESBは「企業内の複数システムをバス型の統合基盤で接続し、ルーティングや変換を担う構成です。」点を主に扱うため、導入目的と責務境界を分けて判断する |
| API Gateway Pattern | API Gateway Patternは関連する問題領域で使われる。ESBは「企業内の複数システムをバス型の統合基盤で接続し、ルーティングや変換を担う構成です。」点を主に扱うため、導入目的と責務境界を分けて判断する |
| Broker Architecture | Broker Architectureは関連する問題領域で使われる。ESBは「企業内の複数システムをバス型の統合基盤で接続し、ルーティングや変換を担う構成です。」点を主に扱うため、導入目的と責務境界を分けて判断する |
