...
| 比較対象 | 違い |
| --- | --- |
| MVC | MVCは関連する問題領域で使われる。MVPは「ModelとViewの間にPresenterを置き、表示ロジックや入力処理の調整をPresenterに集めるUIアーキテクチャです。」点を主に扱うため、導入目的と責務境界を分けて判断する |
| MVVM | MVVMは関連する問題領域で使われる。MVPは「ModelとViewの間にPresenterを置き、表示ロジックや入力処理の調整をPresenterに集めるUIアーキテクチャです。」点を主に扱うため、導入目的と責務境界を分けて判断する |
| Flux | Fluxは関連する問題領域で使われる。MVPは「ModelとViewの間にPresenterを置き、表示ロジックや入力処理の調整をPresenterに集めるUIアーキテクチャです。」点を主に扱うため、導入目的と責務境界を分けて判断する |
