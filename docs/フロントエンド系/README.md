...
| [Feature-Sliced Design](./Feature-Sliced%20Design.md) | フロントエンドコードをapp、pages、widgets、features、entities、sharedなどの層とスライスで整理する設計手法です。 |
| [Atomic Design](./Atomic%20Design.md) | UIをatoms、molecules、organisms、templates、pagesのような粒度で整理するデザインシステムの考え方です。 |
...
| [Backend for Frontend](./Backend%20for%20Frontend.md) | Web、モバイル、管理画面などフロントエンドの種類ごとに専用のバックエンドAPI層を設けるパターンです。 |
