...
| 比較対象 | 違い |
| --- | --- |
| MVP | MVPは関連する問題領域で使われる。MVCは「Model、View、Controllerに分け、入力処理、表示、状態や業務データを分離する基本的なUIアーキテクチャです。」点を主に扱うため、導入目的と責務境界を分けて判断する |
| MVVM | MVVMは関連する問題領域で使われる。MVCは「Model、View、Controllerに分け、入力処理、表示、状態や業務データを分離する基本的なUIアーキテクチャです。」点を主に扱うため、導入目的と責務境界を分けて判断する |
| Flux | Fluxは関連する問題領域で使われる。MVCは「Model、View、Controllerに分け、入力処理、表示、状態や業務データを分離する基本的なUIアーキテクチャです。」点を主に扱うため、導入目的と責務境界を分けて判断する |
